...
namespace RevitMCPBridge.Commands
{
    ...
    public class StandardsCommand : IExternalCommand
    {
        ...
        private static void ShowStatsDialog(JObject d)
        {
            ...
            var typesCovered   = d["typesWithCoverage"]?.Value<int>() ?? 0;
            var typesTotal     = d["totalDetailTypes"]?.Value<int>() ?? 0;
            ...
            sb.AppendLine($"Detail types:       {typesCovered} / {typesTotal}");
            ...
            // Gaps — detail types with no coverage
